...
const StaffRolesPermissionsPage = () => {
  ...
  const fetchData = useCallback(async () => {
    setIsLoading(true);
    try {
      // Fetch staff roles from membership_types table
      const { data: fetchedRoles, error } = await supabase
      ...
      setAllPermissionsList(defaultPermissions);
    } catch (error) {
