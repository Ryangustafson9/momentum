import { normalizeRole } from './roleUtility.js';
...
export const getDashboardRoute = (user) => {
  ...
  switch (role) {
    case 'admin':
      console.log('🔍 Routing admin to /staff/staffdashboard');
...
export const roleRouteConfig = {
  admin: {
    ...
    defaultRedirect: '/staff/staffdashboard',
    allowedRoles: ['admin'],
  },
  staff: {
    dashboard: '/staff/staffdashboard',
...
export const getNavigationItems = (user) => {
  ...
  const navigationMap = {
    admin: [
      { path: '/staff/staffdashboard', label: 'Homepage', icon: 'Home' },
